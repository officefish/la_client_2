package com.sla.mvc.controller.bootstrap 
{
	...
	import com.sla.mvc.controller.decklist.AlertEditDeckCommand;
	...
	public class BootstrapController 
	{
		public function BootstrapController(commandMap:ICommandMap)  
		{
			...
			//commandMap.mapEvent(DeckListEvent.EDIT_DECK_FROM_DECKLIST, AlertEditDeckCommand, DeckListEvent);
