package com.sla.mvc.controller.collection 
{
	 ...
	 * @author inozemcev
	 */
	public class CardDestroyedCommand extends StarlingCommand 
	{
		...
		{
			MonsterDebugger.log ('CardDestroyedCommand::execute()');
			...
			var cardPrice:int;
			var dust:int = event.data.dust;
			var count:int = event.data.count;
