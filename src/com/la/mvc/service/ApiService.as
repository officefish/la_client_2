package com.la.mvc.service 
{
	...
	public class ApiService extends Actor
	{
		...
		private function parseDeckList (responseStr:String) :Object {
			...
			for (var i:int = 0; i < responseDecks.length; i ++) {
				...
				deckData = getDeckDataByResponseData (responseDeck);
				decks.push (deckData)
			}
		...
		private function getDeckDataByResponseData (responseDeckData:Object) :DeckData {
		...
		private function getDeckItems (cards:Array) :Array {
			var items:Array = [];
			var cardData:Object;
